...
firstPage.drawText(`${client.first_name} ${client.last_name}`, { x: 70, y: 640, size: 11, color: rgb(0, 0, 0) });
firstPage.drawText(client.phone, { x: 70, y: 615, size: 11, color: rgb(0, 0, 0) });
firstPage.drawText(client.address, { x: 70, y: 588, size: 11, color: rgb(0, 0, 0) });
firstPage.drawText(client.email, { x: 365, y: 640, size: 11, color: rgb(0, 0, 0) });
firstPage.drawText(client.city, { x: 365, y: 616, size: 11, color: rgb(0, 0, 0) });
